...
public class RepositoryManagerFinal extends Shell {
	...
	public RepositoryManagerFinal( Shell shell, RepositoryConnectController controller ) {
	...
	public  void createDialog(RepositoryConnectController controller) {
		try {
			...
			RepositoryManagerFinal shell = new RepositoryManagerFinal(display,controller);
			shell.open();
			shell.layout();
